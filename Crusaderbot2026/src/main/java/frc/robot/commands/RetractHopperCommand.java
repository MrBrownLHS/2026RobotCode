 ...
 */
public class RetractHopperCommand extends StartEndCommand {
  
  public RetractHopperCommand(SuperSystem superSystem, Hopper hopper, RearIntakeLift rearIntakeLift) {
    super(
